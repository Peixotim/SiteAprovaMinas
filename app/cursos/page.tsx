        ...
        <div className='flex flex-col min-h-screen bg-white text-slate-800'>
                            ...
                            >
                                ...
                                <CardContent className="p-6">
                                    <div className="flex flex-wrap gap-2 mb-4">
                                        {/* Tag 'Tipo' (Presume que seu JSON tenha "Técnico por Competência" no campo 'type') */}
                                        <span className="text-xs font-semibold uppercase px-3 py-1 bg-blue-100 text-[#1b4965] rounded-full">
                                            {curso.type}
                                        </span>
                                        {/* Tag 'Emissão' (Para credibilidade) */}
            ...
            <section className="py-24 bg-white">
                <div className="container mx-auto px-4 text-center max-w-3xl">
                    ...
                    <Link href="/parceria" passHref> {/* Mude "/parceria" para sua página de contato/parceria */}
                        <Button
                            size="lg"
