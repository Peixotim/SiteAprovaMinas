...
const ModalTermosDeUso = ({ onClose }: TermosDeUsoProps) => {
    ...
    return (
        <div className="fixed inset-0 bg-slate-900/60 flex items-center justify-center p-4 z-50">
            <div ref={contentRef} className="bg-white p-6 rounded-xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto relative border-2 border-secondary/20">

                {/* Header com gradiente brand */}
                <div className="bg-gradient-to-r from-[hsl(var(--brand-primary))] to-[hsl(var(--brand-dark))] rounded-t-lg -m-6 mb-6 p-6">
                    <div className="flex items-center justify-between">
                        <div>
                            <h1 className="text-2xl font-bold text-white mb-2">Termos de Uso</h1>
                            <p className="text-brand-secondary-soft text-sm">Versão vigente: {new Date().toLocaleDateString('pt-BR')}</p>
                        </div>
                        <button
                            className="text-white hover:text-brand-highlight text-2xl font-bold transition-all duration-200 hover:scale-110 w-10 h-10 flex items-center justify-center rounded-full hover:bg-white/10"
                            onClick={onClose}
                ...
                <div className="text-gray-800 space-y-6">
                    {/* Seção de Introdução */}
                    <section className="bg-secondary/10 rounded-lg p-4 border-l-4 border-secondary">
                        <h2 className="text-lg font-semibold text-brand-secondary-contrast mb-2">Aceitação dos Termos</h2>
                    ...
                    <section className="space-y-4">
                        <h2 className="text-xl font-bold text-brand-secondary-contrast border-b border-secondary/30 pb-2">
                            1. Definições e Âmbito de Aplicação
                        </h2>

                        <div className="grid md:grid-cols-2 gap-4">
                        <div className="bg-white border border-secondary/30 rounded-lg p-4">
                                <h3 className="font-semibold text-brand-secondary-contrast mb-2 flex items-center">
                    ...
                    <section className="space-y-4">
                        ...
                        <div className="bg-secondary/10 p-4 rounded-lg border border-secondary/30">
                            <h3 className="font-semibold text-brand-secondary-contrast mb-3">Alterações Contratuais</h3>
                            <p className="text-sm text-brand-secondary-contrast/80 mb-3">
                            ...
                            <div className="grid md:grid-cols-3 gap-3 text-xs">
                                <div className="text-center">
                                    <div className="bg-brand-secondary-soft rounded-full w-8 h-8 flex items-center justify-center mx-auto mb-1">
                                        <span className="text-brand-secondary-contrast font-bold">1</span>
                                    </div>
                                    <p className="text-brand-secondary-contrast">Comunicação prévia</p>
                                </div>
                                <div className="text-center">
                                    <div className="bg-brand-secondary-soft rounded-full w-8 h-8 flex items-center justify-center mx-auto mb-1">
                                        <span className="text-brand-secondary-contrast font-bold">2</span>
                                    </div>
                                    <p className="text-brand-secondary-contrast">Aceitação tácita</p>
                                </div>
                                <div className="text-center">
                                    <div className="bg-brand-secondary-soft rounded-full w-8 h-8 flex items-center justify-center mx-auto mb-1">
                                        <span className="text-brand-secondary-contrast font-bold">3</span>
                                    </div>
                                    <p className="text-brand-secondary-contrast">Vigência imediata</p>
                                </div>
                            </div>
                        </div>
                    ...
                    {/* Aviso Final */}
                    <section className="bg-gradient-to-r from-[hsl(var(--brand-primary))] to-[hsl(var(--brand-secondary))] rounded-lg p-4 text-white">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-center pt-6 mt-6 border-t border-secondary/20 gap-4">
                    ...
                    <div className="flex gap-3">
                        ...
                        <button
                            onClick={onClose}
                            className="bg-secondary hover:bg-brand-highlight text-secondary-foreground font-medium py-2 px-6 rounded-lg transition-all duration-200 transform hover:scale-105 shadow-brand"
                        >
